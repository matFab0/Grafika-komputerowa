...
namespace ColorExtractor
{
        ...
        public unsafe class BmpPixelSnoop : IDisposable
        {
            ...
            public BitmapImage BmpImageFromBmp()
            {
                using (MemoryStream memory = new System.IO.MemoryStream())
                {
                    wrappedBitmap.Save(memory, System.Drawing.Imaging.ImageFormat.Png);
                    memory.Position = 0;
